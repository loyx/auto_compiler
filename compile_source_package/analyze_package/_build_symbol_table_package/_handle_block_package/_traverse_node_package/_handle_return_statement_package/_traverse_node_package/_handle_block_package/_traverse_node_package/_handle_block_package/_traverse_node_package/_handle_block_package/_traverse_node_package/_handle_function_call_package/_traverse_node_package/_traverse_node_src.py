...
def _traverse_node(node: AST, symbol_table: SymbolTable) -> None:
    """
    Traverse an AST node and dispatch to appropriate handler based on node type.
    
    Args:
        node: AST node to process
        symbol_table: Symbol table for semantic analysis and error recording
    
    Side effects:
        - Calls appropriate handler function based on node type
        - Handlers may modify symbol_table (e.g., record errors)
    """
...
# === helper functions ===
# No helper functions - all logic is delegated to child handler functions
